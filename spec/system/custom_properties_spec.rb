  ...
  describe 'Manifestation' do
    ...
    describe 'When logged in as Librarian' do
      ...
      it 'should show custom property' do
        ...
        expect(page).to have_content @manifestation.custom_properties.first.name
    ...
    describe 'When logged in as User' do
      ...
      it 'should not show custom property' do
        visit manifestation_path(@manifestation.id, locale: :ja)
        expect(page).not_to have_content @manifestation.custom_properties.first.name
  ...
  describe 'Item' do
    ...
    describe 'When logged in as Librarian' do
      ...
      it 'should show custom property' do
        ...
        expect(page).to have_content @item.custom_properties.first.name
    ...
    describe 'When logged in as User' do
      ...
      it 'should not show custom property' do
        visit item_path(@item.id, locale: :ja)
        expect(page).not_to have_content @item.custom_properties.first.name
