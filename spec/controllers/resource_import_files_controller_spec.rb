  ...
  describe 'POST create' do
    describe 'When logged in as Librarian' do
      ...
      it 'should create resource_import_file' do
        post :create, params: { resource_import_file: { attachment: fixture_file_upload('resource_import_file_sample1.tsv', 'text/csv'), edit_mode: 'create', default_shelf_id: 1 } }
      ...
      it 'should not create resource_import_file without default_shelf_id' do
        post :create, params: { resource_import_file: { attachment: fixture_file_upload('resource_import_file_sample1.tsv', 'text/csv'), edit_mode: 'create' } }
        expect(assigns(:resource_import_file)).not_to be_valid
        assigns(:resource_import_file).user.username.should eq @user.username
        expect(response).to be_successful
      end
    ...
    describe 'When logged in as User' do
      ...
      it 'should be forbidden' do
        post :create, params: { resource_import_file: { attachment: fixture_file_upload('resource_import_file_sample1.tsv', 'text/csv') } }
