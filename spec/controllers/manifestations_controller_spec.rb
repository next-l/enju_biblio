  ...
  describe "GET index", :solr => true do
    ...
    describe "When not logged in" do
      ...
      it "should get index with pub_date_from" do
        ...
        response.should be_success
        assigns(:manifestations).should be_truty
    ...
    describe "When logged in as Administrator" do
      ...
      describe "with valid params" do
        ...
        it "assigns a series_statement" do
          ...
          assigns(:manifestation).series_statements.pluck(:original_title).include?(series_statements(:one).original_title).should be_truty
        end
    ...
    describe "When logged in as Administrator" do
      ...
      describe "with valid params" do
        ...
        it "assigns a series_statement" do
          ...
          assigns(:manifestation).reload
          assigns(:manifestation).series_statements.pluck(:original_title).include?(series_statements(:two).original_title).should be_truty
        end
