  ...
  describe 'POST create' do
    describe 'When logged in as Librarian' do
      ...
      it 'should create agent_import_file' do
        post :create, params: { agent_import_file: { agent_import: fixture_file_upload('files/agent_import_file_sample1.tsv', 'text/csv') } }
      ...
      it 'should import user' do
        ...
        post :create, params: { agent_import_file: { agent_import: fixture_file_upload('files/agent_import_file_sample2.tsv', 'text/csv') } }
