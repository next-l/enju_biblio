...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency "enju_inventory", "~> 0.3.0.beta1"
  s.add_development_dependency "enju_bookmark", "~> 0.3.0.beta1"
  ...
  s.add_development_dependency "enju_oai", "~> 0.3.0.beta1"
