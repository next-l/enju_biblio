...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency "enju_inventory", "~> 0.1.11.pre2"
  s.add_development_dependency "enju_bookmark", "~> 0.1.2.pre3"
  s.add_development_dependency "enju_event", "~> 0.1.17.pre3"
...
#  s.add_development_dependency "enju_circulation", "~> 0.1.0.pre7"
